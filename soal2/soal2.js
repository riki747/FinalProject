...
var updated_lirik_lagu = __assign(__assign({}, lirik_lagu), { data: __assign(__assign({}, lirik_lagu.data), { artist: "Rhiki", songTitle: "Bebas" }) });
console.log(updated_lirik_lagu);
var lirikTertentu = lirik_lagu.data.songLyricsArr[1];
